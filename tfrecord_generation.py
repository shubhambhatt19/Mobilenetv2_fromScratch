...
# from object_detection import dataset_util
import io
from PIL import Image
writer = tf.io.TFRecordWriter("record/train.record")
...
### To inpspect the tfrecord
# def inspectsingletfreocrd(fname):
#     input_dset = tf.data.TFRecordDataset(fname)
#     for sample in input_dset:
#         example = tf.train.Example()
#         example.ParseFromString(sample.numpy())
#         feature = dict(example.features.feature.items())
#         print(feature)
#         break